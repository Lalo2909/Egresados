...
$edicionFacultad=$conn->query($consulta3);
?>
...
<body class="signup-page sidebar-collapse">
  ...
  <div class="page-header header-filter" filter-color="purple" style="background-image: url('img/unidad.jpg')">
      ...
      <div class="row">
        <div class="col-md-10 ml-auto mr-auto">
          <div class="card card-signup">
            <h2 class="card-title text-center">Catálogo de Facultades</h2>
            <div class="text-center">
              <a class="btn btn-primary btn-round" href="#alta_facultad" data-toggle="modal" data-target="#addFacultad">
            ...
            <div class="card-body">
              <div class="form-group" style="overflow-x:auto;">
                <table class='table center .table-bordered' id='tablaReporte'>
                  ...
                  <?php
                    $sql = "SELECT facultad.Nombre, institucion.Nombre, institucion.cve_institucion, facultad.cve_facultad FROM facultad, institucion WHERE facultad.cve_institucion = institucion.cve_institucion";
                  ...
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-primary btn-round" data-toggle="modal" data-target="#editarFacultad" onclick="editarFacultad('<?php echo $datos ?>')"><i class="material-icons">edit</i></button>
				            </td>
                    <td>
                      <button class="btn btn-primary btn-round" onclick="bajaFacultad('<?php echo $row[0] ?>')">
    ...
    <!-- Modal Add Facultad -->
    <form action="alta_facultad.php" method="POST">
      <div class="modal fade" id="addFacultad" role="dialog">
        <div class="modal-dialog">
          <!-- Modal content-->
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <span>Nombre: </span>
            	<div class="input-group">
              	<span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              	<input type="text" name="facultadAlta" class="form-control" placeholder="Facultad" id="facultadAlta">
            	</div>
              <br>
    ...
    <form action="editar_facultad.php" method="POST">
      <div class="modal fade" id="editarFacultad" role="dialog">
        <div class="modal-dialog">
          <!-- Modal content-->
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <span>Nombre: </span>
            	<div class="input-group">
              	<span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
              	<input type="text" name="inputEditarFacultad" class="form-control" id="inputEditarFacultad">
                <input type="hidden" id="facultadId" name="facultadId">
            	</div>
              <br>
              <div class="input-group-prepend">
                <span class="input-group-text">
              ...
              <select class="form-control" id="inputEditarUniversidadFac" name="inputEditarUniversidadFac">
                  <?php

                  while($fila2=$edicionFacultad->fetch_row()){
