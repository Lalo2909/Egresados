      ...
      <div class="row">
        <div class="col-md-10 ml-auto mr-auto">
          <div class="card card-signup">
            <h2 class="card-title text-center">Resultado de Busqueda</h2>
            <div class="card-body">
              <div class="form-group" style="overflow-x:auto;">
                <table class='table center .table-bordered' id='tablaBusqueda'>
                  <tr>
                    <th>Nombre</th>
                    <th>Apellidos</th>
